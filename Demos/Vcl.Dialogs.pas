...
begin
      ...
      if E is EDivByZero then
        MessageDlg( 'ÕœÀ «·Œÿ√ «· «·Ì : ' +#13+#13+ '·«Ì„ﬂ‰ «·ﬁ”„… ⁄·Ï ’›—' +#13,mtError,[mbOK],0)
//else  if E is EConvertError  then
//        MessageDlg( 'ÕœÀ «·Œÿ√ «· «·Ì : ' +#13+#13+ 'ﬁÌ„… €Ì— ’ÕÌÕ…!' +#13+E.Message,mtError,[mbOK],0)
else     if Pos('duplicate values', E.Message) <> 0 then
     MessageDlg('ÕœÀ «·Œÿ√ «· «·Ì : ' +#13+'·«Ì„ﬂ‰ «·Õ›Ÿ , «·»Ì«‰«  „ﬂ——… !'+#13+ E.Message+#13,mtError,[mbOK],0)
else
 MessageDlg( 'ÕœÀ «·Œÿ√ «· «·Ì : ' +#13+#13+ E.Message+#13,mtError,[mbOK],0);
