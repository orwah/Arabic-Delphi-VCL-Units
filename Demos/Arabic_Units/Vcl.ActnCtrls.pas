...
begin
  ...
  try
    ...
    DrawArrow(TempCanvas, sdDown,
      Point((ClientWidth - GetDropDownButtonWidth div 2) - Round(2 * FScaleFactor) - 1,
            ClientHeight div 2 - 1), Round(2 * FScaleFactor));
  finally
    TempCanvas.Handle := 0;
    TempCanvas.Free;
  end;
...
begin
  Result := Round(9 * FScaleFactor); // default drop down button width
end;
