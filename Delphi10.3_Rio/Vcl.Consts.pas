...
resourcestring
  ...
  SUnknownStreamFormat = 'تنسيق المجرى stream غير مدعوم';
...
{$ENDIF}
  ...
  SServiceUninstallFailed = 'الخدمة "%s" فشل إلغاء تنصيبها , الخطأ: "%s"';
  ...
  SNameActiveBorder = 'حد فعال';
  SNameActiveCaption = 'عنوان فعال';
  SNameAppWorkSpace = 'مساحة عمل التطبيق';
  SNameBackground = 'الخلفية';
  SNameBtnFace = 'وجه الزر';
  SNameBtnHighlight = 'إشراق الزر';
  SNameBtnShadow = 'ظل الزر';
  SNameBtnText = 'نص الزر';
  SNameCaptionText = 'نص العنوان';
  SNameDefault = 'افتراضي';
  SNameGradientActiveCaption = 'عنوان فعال متدرج';
  SNameGradientInactiveCaption = 'عنوان غيرفعال متدرج';
  SNameGrayText = 'نص رمادي';
  SNameHighlight = 'خلفية مشرقة';
  SNameHighlightText = 'نص مشرق';
  SNameHotLight = 'ضوء حار';
  SNameInactiveBorder = 'حد غير فعال';
  SNameInactiveCaption = 'عنوان غير فعال';
  SNameInactiveCaptionText = 'نص عنوان غير فعال';
  SNameInfoBk = 'خلفية معلومات';
  SNameInfoText = 'نص معلومات';
  SNameMenu = 'خلفية القائمة';
  SNameMenuBar = 'شريط القائمة';
  SNameMenuHighlight = 'قائمة مشرقة';
  SNameMenuText = 'نص القائمة';
  SNameNone = 'لاشيء';
  SNameScrollBar = 'شريط الأدوات';
  SName3DDkShadow = 'ظل 3بعد';
  SName3DLight = 'ضوء 3بعد';
  SNameWindow = 'خلفية النافذة';
  SNameWindowFrame = 'إطار النافذة';
  SNameWindowText = 'نص النافذة';
